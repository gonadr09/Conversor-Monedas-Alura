...
public class ConvertidorDeMoneda implements MonedaConvertible {
    ...
    public BigDecimal convertirParaMoneda(Moneda moneda, BigDecimal valorEnPeso) {
        return valorEnPeso.divide(moneda.getFACTOR_CONVERSION(), 2, RoundingMode.HALF_UP);
    }
